...
public class ChessBoardPatternTest {
    ...
    {
        assertEquals("Number of Columns is 8",ChessBoardPattern.CountColumns());
    }
    ...
    {
        assertEquals("Number of Rows is 8",ChessBoardPattern.CountRows());
    }
    ...
    {
        assertEquals("Number of Rows is 8",ChessBoardPattern.CheckFirstCell());
    }
}